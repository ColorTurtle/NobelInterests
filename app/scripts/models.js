...
// WORKING WITH ONLY 12 ARTISTS for the practice but will move to 50ish once we put into production
	// API call by genre
	url: 'http://developer.echonest.com/api/v4/artist/search?api_key=RMUWZHZJZCSLALMHF&format=jsonp&results=20&bucket=hotttnesss&bucket=discovery&bucket=genre&bucket=artist_location&bucket=images&bucket=familiarity&callback=?',
